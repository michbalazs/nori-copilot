...
(() => {
  ...
  var require_object_assign = __commonJS({
    "node_modules/object-assign/index.js"(exports, module) {
      "use strict";
      var import_browser3 = __toESM(require_browser());
      ...
      if (true) {
        (function() {
          ...
          if (enableStableConcurrentModeAPIs) {
            React3.ConcurrentMode = REACT_CONCURRENT_MODE_TYPE;
            React3.Profiler = REACT_PROFILER_TYPE;
            React3.unstable_ConcurrentMode = void 0;
            React3.unstable_Profiler = void 0;
          }
      ...
      if (true) {
        (function() {
          ...
          function createWorkInProgress(current2, pendingProps, expirationTime) {
            ...
            if (workInProgress === null) {
              ...
              workInProgress.stateNode = current2.stateNode;
              {
                ...
                workInProgress._debugHookTypes = current2._debugHookTypes;
              }
            ...
            workInProgress.contextDependencies = current2.contextDependencies;
          ...
          function markCommittedPriorityLevels(root2, earliestRemainingTime) {
            ...
            if (earliestRemainingTime < root2.latestPingedTime) {
              root2.latestPingedTime = NoWork;
            }
            var latestPendingTime = root2.latestPendingTime;
          ...
          function renderWithHooks(current2, workInProgress, Component, props, refOrContext, nextRenderExpirationTime2) {
          ...
          function bailoutHooks(current2, workInProgress, expirationTime) {
            workInProgress.updateQueue = current2.updateQueue;
          ...
          function updateForwardRef(current$$1, workInProgress, Component, nextProps, renderExpirationTime2) {
            ...
            prepareToReadContext(workInProgress, renderExpirationTime2);
            {
              ...
              nextChildren = renderWithHooks(current$$1, workInProgress, render, nextProps, ref, renderExpirationTime2);
              if (debugRenderPhaseSideEffects || debugRenderPhaseSideEffectsForStrictMode && workInProgress.mode & StrictMode) {
            ...
            if (current$$1 !== null && !didReceiveUpdate) {
              bailoutHooks(current$$1, workInProgress, renderExpirationTime2);
          ...
          function updateFunctionComponent(current$$1, workInProgress, Component, nextProps, renderExpirationTime2) {
            ...
            prepareToReadContext(workInProgress, renderExpirationTime2);
            {
              ReactCurrentOwner$3.current = workInProgress;
              setCurrentPhase("render");
              nextChildren = renderWithHooks(current$$1, workInProgress, Component, nextProps, context, renderExpirationTime2);
              if (debugRenderPhaseSideEffects || debugRenderPhaseSideEffectsForStrictMode && workInProgress.mode & StrictMode) {
                if (workInProgress.memoizedState !== null) {
                  nextChildren = renderWithHooks(current$$1, workInProgress, Component, nextProps, context, renderExpirationTime2);
                }
          ...
          function updateClassComponent(current$$1, workInProgress, Component, nextProps, renderExpirationTime2) {
            ...
            var nextUnitOfWork2 = finishClassComponent(current$$1, workInProgress, Component, shouldUpdate, hasContext, renderExpirationTime2);
            {
          ...
          function mountIndeterminateComponent(_current, workInProgress, Component, renderExpirationTime2) {
            ...
            var value = void 0;
            {
              ...
              ReactCurrentOwner$3.current = workInProgress;
              value = renderWithHooks(null, workInProgress, Component, props, context, renderExpirationTime2);
            }
            workInProgress.effectTag |= PerformedWork;
              ...
              if (enableSuspenseServerRenderer) {
                if (nextProps.fallback !== void 0) {
                  ...
                  if (workInProgress.tag === DehydratedSuspenseComponent) {
                    return updateDehydratedSuspenseComponent(null, workInProgress, renderExpirationTime2);
                  }
                }
              }
              if (nextDidTimeout) {
          ...
          function updateDehydratedSuspenseComponent(current$$1, workInProgress, renderExpirationTime2) {
            if (current$$1 === null) {
            ...
            if (didReceiveUpdate || hasContextChanged$$1) {
              ...
              workInProgress.effectTag |= Placement;
              return updateSuspenseComponent(null, workInProgress, renderExpirationTime2);
            }
            if ((workInProgress.effectTag & DidCapture) === NoEffect) {
          ...
          function beginWork(current$$1, workInProgress, renderExpirationTime2) {
            ...
            switch (workInProgress.tag) {
              ...
              case MemoComponent: {
                ...
                return updateMemoComponent(current$$1, workInProgress, _type2, _resolvedProps3, updateExpirationTime, renderExpirationTime2);
              }
              ...
              case DehydratedSuspenseComponent: {
                if (enableSuspenseServerRenderer) {
                  return updateDehydratedSuspenseComponent(current$$1, workInProgress, renderExpirationTime2);
                }
                break;
              }
            }
          ...
          function propagateContextChange(workInProgress, context, changedBits, renderExpirationTime2) {
            ...
            while (fiber !== null) {
              ...
              if (list !== null) {
                ...
                scheduleWorkOnParentPath(fiber, renderExpirationTime2);
          ...
          function prepareToReadContext(workInProgress, renderExpirationTime2) {
            ...
            if (currentDependencies !== null && currentDependencies.expirationTime >= renderExpirationTime2) {
              markWorkInProgressReceivedUpdate();
            }
            ...
            do {
              switch (workInProgress.tag) {
                case HostRoot: {
                  ...
                  workInProgress.expirationTime = renderExpirationTime2;
                  var _update = createRootErrorUpdate(workInProgress, _errorInfo, renderExpirationTime2);
                ...
                case ClassComponent:
                  ...
                  if ((workInProgress.effectTag & DidCapture) === NoEffect && (typeof ctor.getDerivedStateFromError === "function" || instance !== null && typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance))) {
                    workInProgress.effectTag |= ShouldCapture;
                    workInProgress.expirationTime = renderExpirationTime2;
                    var _update2 = createClassErrorUpdate(workInProgress, errorInfo, renderExpirationTime2);
          ...
          function scheduleCallbackWithExpirationTime(root2, expirationTime) {
            ...
            callbackID = scheduler.unstable_scheduleCallback(performAsyncWork, { timeout });
          }
          ...
          function ReactRoot(container, isConcurrent, hydrate) {
            var root2 = createContainer(container, isConcurrent, hydrate);
          ...
          if (enableStableConcurrentModeAPIs) {
            ...
            ReactDOM2.unstable_createRoot = void 0;
          }
  ...
  function NoriChat() {
    const src = "https://copilotstudio.preview.microsoft.com/environments/06552ecd7a49-e093-8ac6-15c2103f134b/bots/crc9f_noriStaffSupportCopilot/webchat?__version__=2";
  ...
  import_react_dom.default.render(
    /* @__PURE__ */ import_react2.default.createElement(NoriChat, null),
